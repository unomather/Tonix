...
import tonix.app.app_ui_small.navigation.screen.ui.create_import_wallet.CreateImportWalletAction.NavigateToCreatePinCode
...
internal class CreateImportWalletViewModel: BaseViewModel<S, I, A>(Default) {
    override suspend fun Ctx.handleIntents(intent: I) {
        when (intent) {
            is OnCreateWalletClicked -> action(NavigateToCreatePinCode)
